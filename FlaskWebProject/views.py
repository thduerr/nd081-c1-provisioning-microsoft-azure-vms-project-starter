...
def authorized():
    ...
    if request.args.get("code"):
        ...
        result = app.acquire_token_by_authorization_code(request.args["code"], scopes=Config.SCOPE, redirect_uri=url_for("authorized", _external=True, _scheme="https"))
        if "error" in result:
...
def _build_auth_url(authority=None, scopes=None, state=None):
    ...
    return app.get_authorization_request_url(scopes or [], state=state or str(uuid.uuid4()), redirect_uri=url_for("authorized", _external=True, _scheme="https"))
